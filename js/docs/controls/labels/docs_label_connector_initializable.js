/**
 * @module DocsConnectorInitializableLabel
 * A simple label to give an example in the documentation.
 * It is initialized with connector's data.
 * 
 * @version 1.0.0
 * @license MIT License
...
export class DocsConnectorInitializableLabel extends DocsStringDataConnectorInitializable(
	...
	static getTagName(){
		return 'docs-connector-initializable-label';
	}
