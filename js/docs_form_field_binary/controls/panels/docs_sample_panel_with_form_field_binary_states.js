/**
 * @module DocsSamplePanelWithFormFieldBinaryStates
 * A simple panel to give an example in the documentation.
 * The goal is to show how a KoiFormFieldBinary can change its state.
...
class DocsErrorDisplayableFormFieldBinary extends KoiFormFieldBinary {

	static getTagName(){
		return 'docs-error-displayable-form-field-binary';
	}
...
if (customElements.get(DocsErrorDisplayableFormFieldBinary.getTagName()) === undefined) {
	customElements.define(DocsErrorDisplayableFormFieldBinary.getTagName(), DocsErrorDisplayableFormFieldBinary);
}

class DocsSamplePanelWithFormFieldBinaryStatesSocket extends KoiSocketTemplateCapable(KoiCompositeSocket) {

	static getCheckActionCode(){
		return 'check';
	}

	static getUncheckActionCode(){
		return 'uncheck';
	}
			...
			'<div class="row g-0">' +
				'<div class="col">' +
					'<div class="card-body">' +
						KoiIdButton.getTag({
							...
							item_action: DocsSamplePanelWithFormFieldBinaryStatesSocket.getSetReadonlyActionCode(),
							btn_enabled: true,
						...
						KoiIdButton.getTag({
							...
							item_action: DocsSamplePanelWithFormFieldBinaryStatesSocket.getUnsetReadonlyActionCode(),
							btn_enabled: true,
						...
						KoiIdButton.getTag({
							...
							item_action: DocsSamplePanelWithFormFieldBinaryStatesSocket.getDisableActionCode(),
							btn_enabled: true,
							placeholder: 'disable',
							btn_class: 'btn-primary d-block mb-1'
						}) +
						KoiIdButton.getTag({
							...
							item_action: DocsSamplePanelWithFormFieldBinaryStatesSocket.getEnableActionCode(),
							btn_enabled: true,
							placeholder: 'enable',
							btn_class: 'btn-primary d-block mb-1'
						}) +
						KoiIdButton.getTag({
							...
							item_action: DocsSamplePanelWithFormFieldBinaryStatesSocket.getDisplayErrorActionCode(),
							btn_enabled: true,
						...
						KoiIdButton.getTag({
							...
							item_action: DocsSamplePanelWithFormFieldBinaryStatesSocket.getRemoveErrorActionCode(),
							btn_enabled: true,
				...
				'<div class="col">' +
					'<div class="card-body">' +
						...
						DocsErrorDisplayableFormFieldBinary.getTag({
							element_id: this.getID('form_field_binary'),
							field_name: 'some_id',
							field_value: DocsSamplePanelWithFormFieldBinaryStatesSocket.getCheckActionCode(),
							checked_value: DocsSamplePanelWithFormFieldBinaryStatesSocket.getCheckActionCode(),
							not_checked_value: DocsSamplePanelWithFormFieldBinaryStatesSocket.getUncheckActionCode(),
	...
	_setInputReadonly(){
		this._items['form_field_binary'].setReadonly();
	}

	_removeInputReadonly(){
		this._items['form_field_binary'].removeReadonly();
	}

	_disableInput(){
		this._items['form_field_binary'].disable();
	}

	_enableInput(){
		this._items['form_field_binary'].enable();
	}

	_displayError(){
		this._items['form_field_binary'].displayError();
	}

	_removeError(){
		this._items['form_field_binary'].removeError();
	}

	displayFormFieldState(action){
		if(action === DocsSamplePanelWithFormFieldBinaryStatesSocket.getSetReadonlyActionCode()){
			this._setInputReadonly();
		}else if(action === DocsSamplePanelWithFormFieldBinaryStatesSocket.getUnsetReadonlyActionCode()){
			this._removeInputReadonly();
		}else if(action === DocsSamplePanelWithFormFieldBinaryStatesSocket.getDisableActionCode()){
			this._disableInput();
		}else if(action === DocsSamplePanelWithFormFieldBinaryStatesSocket.getEnableActionCode()){
			this._enableInput();
		}else if(action === DocsSamplePanelWithFormFieldBinaryStatesSocket.getDisplayErrorActionCode()){
			this._displayError();
		}else if(action === DocsSamplePanelWithFormFieldBinaryStatesSocket.getRemoveErrorActionCode()){
			this._removeError();
		}
	}
	...
	_getEmptySchemaIds(){
		return {
			...
			'form_field_binary': this._holder.id + '_form_field_binary'
		};
	}

}

const DocsSamplePanelWithFormFieldBinaryStatesSocketConnectable = Sup => class extends KoiSocketConnectable(Sup) {
	...
	_constructSocket(){
		return new DocsSamplePanelWithFormFieldBinaryStatesSocket({
			holder: this
		});
	}
...
export class DocsSamplePanelWithFormFieldBinaryStates extends DocsSamplePanelWithFormFieldBinaryStatesSocketConnectable(
	...
	static getTagName(){
		return 'docs-sample-panel-with-form-field-binary-states';
	}
